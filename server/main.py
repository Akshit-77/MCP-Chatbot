...
A custom MCP server that provides data analysis tools for CSV and Excel files.
Supports dataset loading, analysis, visualization, and data processing operations.
"""
...
def _list_available_datasets() -> Dict[str, Any]:
...
def _dataset_info(filename: str) -> Dict[str, Any]:
